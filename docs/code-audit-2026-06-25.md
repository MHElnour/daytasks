...
| 2026-06-25 | BAD-4 | _this commit_ | All settings-tab saves route through one guarded `saveSettingsWithNotice()` (try/catch + Notice); toggle/dropdown handlers no longer swallow save failures. Verified by build/typecheck (UI glue). |
